...
export const MinimalistTemplate: React.FC<{ resume: ResumeData }> = ({ resume }) => {
  const { personalInfo, experience, education, skills, projects, languages, certificates } = resume;
  
  return (
    <div className="max-w-4xl mx-auto bg-gradient-to-br from-purple-50 to-pink-50 shadow-lg">
      <header className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-8 rounded-t-lg">
          ...
          <div className="col-span-2">
            <section className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-purple-600">Professional Summary</h3>
              </div>
            ...
            <section className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-purple-600">Work Experience</h3>
              </div>
            ...
            {projects && projects.length > 0 && (
              <section className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-purple-600">Projects</h3>
                </div>
                    ...
                    <div key={project.id} className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {project.technologies.map((tech: string, idx: number) => (
                          <span key={idx} className="px-2 py-1 bg-purple-100 text-purple-600 rounded text-sm">
                            {tech}
                          </span>
                        ))}
                      </div>
          ...
          <div>
            ...
            {skills && skills.length > 0 && (
              <section className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  <Award className="text-purple-600" />
                  <h3 className="text-xl font-semibold text-purple-600">Skills</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill: Skill, idx: number) => (
                    <span key={idx} className="px-3 py-1 bg-white rounded-full text-purple-600 shadow-sm">
                      {skill.name}
                    </span>
                  ))}
                </div>
            ...
            {languages && languages.length > 0 && (
              <section className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-purple-600">Languages</h3>
                </div>
            ...
            {certificates && certificates.length > 0 && (
              <section className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  <Award className="text-purple-600" />
                  <h3 className="text-xl font-semibold text-purple-600">Certifications</h3>
                </div>
                <div className="space-y-4">
